...
class Ui_varWin(object):
    def setupUi(self, varWin):
        ...
        self.mvo = QtWidgets.QLabel(self.gridLayoutWidget_2)
        self.mvo.setMaximumSize(QtCore.QSize(16777215, 99999))
        font = QtGui.QFont()
        font.setPointSize(18)
        self.mvo.setFont(font)
        self.mvo.setAlignment(QtCore.Qt.AlignCenter)
        self.mvo.setObjectName("mvo")
        self.gridLayout_2.addWidget(self.mvo, 6, 1, 1, 1)
    ...
    def retranslateUi(self, varWin):
        ...
        self.mvo.setText(_translate("varWin", "TextLabel"))
        self.label_9.setText(_translate("varWin", "Measured Voltage"))
        ...
        self.label_15.setText(_translate("varWin", "mV"))
